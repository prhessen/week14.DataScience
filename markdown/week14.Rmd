...
I know that the "information_Schema" database contains meta-data, so I first
want to explore the "rnlander_8960" database.
...
These variables also appear to be in the same format. 
...
intrusions, and whether this relationship is moderated by age. To beging, I fit 
...
very very small, indicating that there is a significant positive relationship
between how many social media platforms a person has, and how accepting they 
are of privacy intrusions. 

Next, I fit two OLS models, both with age and social media as predictors, and
one including their interaction (the other did not include their interaction). 
...
Running an ANOVA on these two models demonstrated that there was not a 
